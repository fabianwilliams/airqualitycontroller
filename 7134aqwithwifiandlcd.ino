#include <SoftwareSerial.h>     // From WIFI Board to Arduino
...
int threshold = 40;      //Threshold level for Air Quality // For Test ONLY
...
void setup() {
  ...
  mySerial.begin(9600);     // begin serial comm with 9600 baud for WIFI module
...
void loop() {
  ...
  Serial.print("My Serial AQ: "); // logging mySerial Begins
